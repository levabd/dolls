...
namespace SLS.Widgets.Table {
  public class Cell : MonoBehaviour, IPointerEnterHandler,
    ...
    //Storing here the number of seconds the pointer was held down on this cell
    ...
    private void Update() {
      if (this.table.onCellLongPress == null || !this.isDown || (this._element != null && (this._element.datum.isHeader || this._element.datum.isFooter))) return;
