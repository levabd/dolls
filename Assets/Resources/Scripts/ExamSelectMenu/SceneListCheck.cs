...
public  class SceneListCheck
{
    public  string GetSafeSceneName(string sceneName)
    {
        return GetValidVariableName(sceneName);
    }

    public  string GetSafeSceneNameFromPath(string path)
    {
        return GetValidVariableName(Path.GetFileNameWithoutExtension(path));
    }

    private  string GetValidVariableName(string variableName)
    {
