...
class Exam15 : BaseExam
{
    ...
    public override int? CheckAction(string actionCode, out string errorMessage, ref string tipMessage, out bool showAnimation, string locatedColliderTag = "")
    {
        ...
        if (this.VenflonInstallation(actionCode, ref errorMessage, locatedColliderTag, out returnedStep, "lateral_subcutaneous_arm_vein_final_target", ref showAnimation))
            return returnedStep;
