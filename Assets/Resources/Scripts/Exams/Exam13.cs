...
class Exam13 : BaseExam
{
    ...
    public override string Name => "Периферичний венозний доступ №12 Забір крові з латеральної вени ліктьового згину";
    ...
    public override int? CheckAction(string actionCode, out string errorMessage, ref string tipMessage, out bool showAnimation, string locatedColliderTag = "")
    {
        ...
        if (this.FenceInjections(actionCode, ref errorMessage, locatedColliderTag, out returnedStep, "lateral_subcutaneous_arm_vein_final_target", ref showAnimation))
            return returnedStep;
