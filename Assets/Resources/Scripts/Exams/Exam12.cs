...
class Exam12 : BaseExam
{
    ...
    public override string Name => "Периферичний венозний доступ №11 Постановка внутрішньовенного катетера venflon в вену ліктьового згину";
    ...
    public override int? CheckAction(string actionCode, out string errorMessage, ref string tipMessage, out bool showAnimation, string locatedColliderTag = "")
    {
        ...
        if (this.VenflonInstallation(actionCode, ref errorMessage, locatedColliderTag, out returnedStep, "medial_saphenous_vein_final_target", ref showAnimation))
            return returnedStep;
