...
{
    public override string Name => "Периферичний венозний доступ №10 Внутрішньовенна ін'єкція в вену ліктьового згину";
    ...
    public override int? CheckAction(string actionCode, out string errorMessage, ref string tipMessage, out bool showAnimation, string locatedColliderTag = "")
    {
        ...
        if (this.FenceInjections(actionCode, ref errorMessage, locatedColliderTag, out returnedStep, "medial_saphenous_vein_final_target", ref showAnimation, true))
            return returnedStep;
